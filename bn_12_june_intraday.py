...
exp_list = ['13-Jun-24', '12-Jun-24', '11-Jun-24', '14-Jun-24']
#----------------------------------------------------------------
multiple = {
...
#----------------------------------------------------------------
prev_day_data = [
    {'NIFTY': {'use_strike': 23250, 'strd_price': 420.9, 'strd_theta': 5158895}},
    {'BANKNIFTY': {'use_strike': 49700, 'strd_price': 979.8, 'strd_theta': 7972740}},
    {'FINNIFTY': {'use_strike': 22250, 'strd_price': 361, 'strd_theta':   8615694}},
...
for i in range(len(sym_list)):
    ...
    # ----------------------------------------------------------------------------------------------
        ...
        while condition:
            ...
            if count == 376:
                print(f'No column of {sym} {exp} CE and PE have the length 375 in the src data, hence terminating')
                # sys.exit()
                break
        if count > 375:
            continue
    # ----------------------------------------------------------------------------------------------
        ...
        for j in range(range_till):
            ...
            today_date = datetime.datetime.strptime('10-jun-24', '%d-%b-%y').date()  # fixing 05-jun for testing
