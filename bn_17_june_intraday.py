...
#----------------------------------------------------------------
prev_day_data = [
    {'NIFTY': {'use_strike': 23450, 'strd_price': 283.65, 'strd_theta': 3397943}},
    {'BANKNIFTY': {'use_strike': 49900, 'strd_price': 670.85, 'strd_theta': 5530054}},
    {'FINNIFTY': {'use_strike': 22350, 'strd_price': 214.25, 'strd_theta':   5123000}},
    {'MIDCPNIFTY': {'use_strike': 11925, 'strd_price': 93.2, 'strd_theta':  4210078}}
]
# prev_day_data = [
#
...
for i in range(len(sym_list)):
    ...
    wb = Workbook()
    wb.remove(wb.active)
    save_to_sheet(df_intraday, 'Intraday', wb, plot_graph = True)
