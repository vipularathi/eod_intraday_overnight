...
prev_day_data = {'use_strike': 22550, 'strd_price': 614, 'strd_theta': 2556025.79255543}
# 49000	BANKNIFTY12JUN2449000CE.NFO	632	BANKNIFTY12JUN2449000PE.NFO	785	1417	7033550.662
# 22550	NIFTY13JUN2422550CE.NFO	304	NIFTY13JUN2422550PE.NFO	310	614	2556025.79255543
...
# ----------------------------------------------------------------------------------------------
    ...
    for j in range(375):
        ...
        # today_date = datetime.datetime.strptime('05-jun-24', '%d-%b-%y').date()  # fixing 28 may for now
    ...
    df_fut.to_csv('test_overnight_n_6june.csv')